...
public class Application_backup extends MessageCracker implements quickfix.Application {
    ...
    public Application_backup(SessionSettings settings) throws ConfigError, FieldConvertError {
    ...
    public void onMessage(quickfix.fix40.NewOrderSingle order, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
        try {
            validateOrder(order);
    ...
    public void onMessage(quickfix.fix44.NewOrderSingle order, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
        try {
            ...
            quickfix.fix44.ExecutionReport accept = new quickfix.fix44.ExecutionReport(
                    ...
                    OrdStatus.NEW),
                    order.getSide(),
                    new LeavesQty(order.getOrderQty()
                    .getValue()),
                    new CumQty(0),
                    new AvgPx(0));
